...
use Thomisticus\Generator\Utils\HTMLFieldGenerator;
...
class ViewGenerator extends BaseGenerator
{
    ...
    private function generateBladeTableBody()
    {
        ...
        $tableBodyFields = implode(generate_new_line_tab(1, 3), $tableBodyFields);
    ...
    private function generateTableHeaderFields()
    {
        ...
        return implode(generate_new_line_tab(1, 2), $headerFields);
    }
