...
class ServiceScaffoldGeneratorCommand extends BaseCommand
{
	/**
	 ...
	 * @var string
	 */
	protected $name = 'thomisticus:service_scaffold';
	 ...
	 * @var string
	 */
	protected $description = 'Create a full Scaffold with Service Layer for given model';
